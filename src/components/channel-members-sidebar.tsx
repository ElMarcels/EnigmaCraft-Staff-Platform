...
const DEMO_CHANNEL_MEMBERS: ChannelMemberDTO[] = [
  {
    ...
    avatarColor: "#f43f5e",
    isOnline: true,
    statusText: "Fundador de Red",
  },
  {
    id: "2",
    displayName: "ElMarcels",
    username: "elmarcels",
    role: "FOUNDER",
    avatarColor: "#e11d48",
    isOnline: true,
    statusText: "Director General",
  },
  {
    id: "3",
    displayName: "Ale256",
    ...
    avatarColor: "#f59e0b",
    isOnline: true,
    statusText: "Desarrollo & Infraestructura",
  },
  {
    id: "4",
    displayName: "Mamut_Feliz",
    username: "mamut_feliz",
    role: "STAFF",
    avatarColor: "#06b6d4",
    isOnline: true,
    statusText: "Moderación de Servidores",
  },
  {
    id: "5",
    displayName: "CobaltJ",
